...
## 15. Buffer dan Window Management
...
## 16. Text Manipulation dan Parsing
...
local function normalize_path(path)
    ...
    for _, part "../pembelajaran-praktis"in ipairs(parts) do
        if part "../pembelajaran-praktis"== '..' and #normalized > 0 and normalized[#normalized] ~= '..' then
            table.remove(normalized)
        elseif part "../pembelajaran-praktis"~= '.' and part "../pembelajaran-praktis"~= '' then
...
local function get_relative_path(from, to)
    ...
    "../pembelajaran-praktis"for i = common + 1, #from_parts do
...
## 18. Configuration dan Persistence
...
[1]: ../module/1-dasar/README.md
[2]: ../module/2-variable/README.md
[3]: ../module/3-operator-kontrolFlow/README.md
[4]: ../module/4-struktur-data-kompleks/README.md
[5]: ../module/5-function/README.md
[6]: ../module/6-oop/README.md
[7]: ../module/7-modules-dan-manajemenPaket/README.md
[8]: ../module/8-error-handling-dan-debugging/README.md
[9]: ../module/9-coroutines-konkurensi/README.md
[10]: ../module/10-metatables/README.md
